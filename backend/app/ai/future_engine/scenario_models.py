...
class FutureBranch:
    ...
    valid_until: datetime = field(default_factory=lambda: datetime.utcnow() + timedelta(hours=2))
    ...
    def get_peak_risk_time(self) -> Optional[TimelinePoint]:
        ...
        return max(self.timeline_points, key=lambda p: p.medical_risk_level + p.crowd_density)
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "timeline_summary": {
                ...
                "peak_risk_time": self.get_peak_risk_time().timestamp.isoformat() if self.get_peak_risk_time() else None,
                "bottlenecks": self.get_bottleneck_predictions()
            },
            
            # Outcomes
            "outcomes": {cat.value: outcome.to_dict() for cat, outcome in self.outcomes.items()},
...
class FutureBranchSet:
    ...
    def calculate_variance_analysis(self):
        ...
        self.variance_analysis = {
            ...
            "high_variance": risk_variance > 0.3 or satisfaction_variance > 30 or density_variance > 0.4,
            "volatility_score": (risk_variance + satisfaction_variance/100 + density_variance) / 3
        }

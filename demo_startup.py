...
async def demo_ai_provider():
    ...
    try:
        ...
        test_messages = [
            AIMessage(role=MessageRole.SYSTEM, content="You are StadiumVerse AI, an intelligent stadium management system."),
            AIMessage(role=MessageRole.USER, content="Provide a brief welcome message for StadiumVerse AI V2, mentioning that you are 'The Living Brain of the Stadium' running on local Ollama. Keep it under 100 words.")
        ]
...
"""
        ...
        analysis_messages = [
            AIMessage(role=MessageRole.SYSTEM, content="You are StadiumVerse AI V2, an intelligent stadium management system known as 'The Living Brain of the Stadium'. You provide clear, actionable recommendations."),
...
"""
        ...
        prediction_messages = [
            AIMessage(role=MessageRole.SYSTEM, content="You are the Future Prediction module of StadiumVerse AI. You predict stadium conditions and recommend preventive measures."),
...
"""
        ...
        narrative_messages = [
            AIMessage(role=MessageRole.SYSTEM, content="You are the AI Storyteller for StadiumVerse, expert at converting technical data into engaging, natural language narratives for stadium operations."),

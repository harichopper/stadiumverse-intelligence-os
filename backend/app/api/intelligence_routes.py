...
from ..ai.collective_intelligence.intelligence_engine import CollectiveIntelligenceEngine
...
async def analyze_situation_and_propose_interventions(
    ...
    try:
        ...
        proposals = await intelligence_engine.analyze_situation_and_propose_interventions(
        ...
        return {
            ...
            "analysis_summary": {
                ...
                "avg_priority_score": sum(p.get_priority_score() for p in proposals) / len(proposals) if proposals else 0,
...
async def get_quick_recommendation(
    ...
    try:
        ...
        return {
            ...
            "urgency_level": "high" if urgency > 0.7 else "medium" if urgency > 0.4 else "low",

...
FANS_DATA = [
    (
        ...
        12,
        95,
        "Goal! We need one more!",
        "Saw Brazil win in 2018",
        "Will stay to celebrate",
        0.94,
    ),
    (
        "F002",
    ...
    (
        ...
        "Attended 2002 WC Korea",
        "Neutral — enjoying game",
        0.79,
    ),
    (
        "F007",
        ...
        "Never been to WC before",
        "Will explore stadium",
        0.92,
    ),
    (
        "F008",
        ...
        70,
        "Reminds me of 2006",
        "Attended 2006 WC Germany",
        "Will leave at final whistle",
        0.83,
    ),
    (
        "F009",
        ...
        "Seen lots of WC footage",
        "Will take many photos",
        0.89,
    ),
    (
        "F010",
        ...
        20,
        88,
        "The crowd energy is amazing!",
        "Followed tournament from Africa",
        "Will attend post-match show",
        0.93,
    ),
]
        ...
        db.add(
            Volunteer(
                ...
                availability=random.choice(
                    ["available", "available", "available", "busy"]
                ),
...
def seed_ai_decisions(db: Session) -> None:
    ...
    decisions = [
        (
            15,
            "Navigation",
            "Open Gate C overflow lane",
            "Gate A density reached 75%. Pre-emptive measure.",
            0.88,
            "SUCCESS",
            2800,
            18.0,
        ...
        (
            28,
            "Medical",
            "Deploy medic to Section S-East",
            "Fan reported dizziness. High heat index.",
            0.95,
            "SUCCESS",
            1,
            100.0,
        ...
        (
            42,
            "Coordinator",
            "Deploy 2 volunteers to food court",
            "Queue > 8 min. Efficiency dropped.",
            0.82,
            "SUCCESS",
            420,
            31.0,
        ...
        (
            55,
            "Transport",
            "Alert Metro Station 2 incoming surge",
            "Model predicts 1,200 fans in 12 min.",
            0.91,
            "SUCCESS",
            1200,
            24.0,
        ...
        (
            62,
            "Security",
            "Soft barriers at Gate B",
            "Crowd pressure rising. Safety threshold.",
            0.87,
            "SUCCESS",
            3400,
            19.0,
        ...
        (
            67,
            "Coordinator",
            "Deploy 3 volunteers → Gate B",
            "Gate B at 94% capacity. 8-min prediction.",
            0.94,
            "SUCCESS",
            1400,
            23.0,
        ...
        (
            72,
            "Navigation",
            "Activate digital rerouting → Gate C",
            "Complement volunteer deployment.",
            0.89,
            "PARTIAL",
            600,
            12.0,
        ...
        (
            78,
            "Medical",
            "Pre-position medical at South Exit",
            "Post-match exit pattern from history.",
            0.85,
            "PENDING",
            5000,
            0.0,
...
def seed_events(db: Session) -> None:
    ...
    events = [
        (
            ...
            "match",
            "Kick-off — BRA vs ARG",
            "FIFA World Cup 2026 Final begins",
            1,
            "Field",
            True,
        ),
        (
            23,
            "goal",
            "GOAL — Neymar Jr. (Brazil 1-0)",
            "Brazilian fans surge in celebration",
            2,
            "N-Stand",
            True,
        ),
        (
            38,
            "crowd",
            "Gate B congestion warning",
            "Flow rate exceeds threshold",
            3,
            "Gate B",
            True,
        ),
        (
            ...
            "73% rain probability next 20 min",
            2,
            "Stadium-wide",
            False,
        ),
        (
            61,
            "goal",
            "GOAL — Lautaro (Argentina 1-1)",
            "Argentine sector erupts",
            2,
            "S-Stand",
            True,
        ),
        (
            67,
            "ai_action",
            "AI deployed 3 volunteers",
            "Gate B congestion resolved",
            1,
            "Gate B",
            True,
        ),
        ...
        (
            85,
            "crowd",
            "Post-match exit preparation",
            "AI pre-positioning teams",
            2,
            "All Gates",
            False,
        ),
    ...
    for min, etype, title, desc, severity, zone, resolved in events:
        db.add(
            StadiumEvent(
                ...
                zone=zone,
                resolved=resolved,
                resolved_at=datetime.utcnow() - timedelta(minutes=90 - min - 5)
                if resolved
                else None,
            )
        )

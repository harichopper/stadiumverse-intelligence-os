...
from app.models.event import WeatherData, TransportStatus
from app.config import STADIUM_ZONES
from geoalchemy2 import WKTElement

# FIFA World Cup 2026 Teams
WORLD_CUP_TEAMS = [
    "Argentina", "Brazil", "France", "England", "Spain", "Germany", "Netherlands", 
    "Portugal", "Belgium", "Croatia", "Italy", "Morocco", "Mexico", "USA", "Canada",
    "Japan", "South Korea", "Australia", "Senegal", "Ghana", "Nigeria", "Egypt",
    "Saudi Arabia", "Iran", "Qatar", "Ecuador", "Uruguay", "Chile", "Colombia", "Peru"
]

# Popular first names by country
NAMES_BY_COUNTRY = {
    "US": ["James", "Mary", "John", "Patricia", "Robert", "Jennifer", "Michael", "Linda", "David", "Elizabeth"],
    "CA": ["Liam", "Emma", "Noah", "Olivia", "William", "Ava", "James", "Isabella", "Benjamin", "Sophia"],
    "MX": ["José", "María", "Luis", "Guadalupe", "Juan", "Margarita", "Antonio", "Juana", "Francisco", "Rosa"],
    "BR": ["Miguel", "Alice", "Arthur", "Laura", "Heitor", "Manuela", "Bernardo", "Luiza", "Théo", "Valentina"],
    "AR": ["Santiago", "Emma", "Mateo", "Olivia", "Sebastián", "Mía", "Matías", "Isabella", "Nicolás", "Sofía"],
    "FR": ["Gabriel", "Emma", "Raphaël", "Louise", "Arthur", "Alice", "Louis", "Chloé", "Jules", "Inès"],
    "DE": ["Ben", "Emma", "Paul", "Hannah", "Leon", "Mia", "Finn", "Sofia", "Noah", "Emilia"],
    "GB": ["Oliver", "Olivia", "George", "Amelia", "Harry", "Isla", "Jack", "Ava", "Jacob", "Emily"],
    "IT": ["Leonardo", "Sofia", "Francesco", "Giulia", "Lorenzo", "Aurora", "Alessandro", "Ginevra", "Andrea", "Alice"],
    "ES": ["Hugo", "Lucía", "Martín", "Sofía", "Lucas", "Martina", "Mateo", "María", "Leo", "Paula"],
    "JP": ["Hiroto", "Himari", "Haruto", "Koharu", "Yuto", "Yui", "Sota", "Rei", "Hayato", "Ichika"],
    "KR": ["Minjun", "Soeun", "Seoung", "Seoyeon", "Yejun", "Jiwoo", "Dohyun", "Chaeyeon", "Eunwoo", "Dayeon"],
}

# Languages by country
LANGUAGES_BY_COUNTRY = {
    "US": "en", "CA": "en", "MX": "es", "BR": "pt", "AR": "es", "FR": "fr", 
    "DE": "de", "GB": "en", "IT": "it", "ES": "es", "JP": "ja", "KR": "ko",
    "MA": "ar", "EG": "ar", "SA": "ar", "IR": "fa", "SN": "fr", "GH": "en",
    "NG": "en", "AU": "en", "QA": "ar", "EC": "es", "UY": "es", "CL": "es",
    "CO": "es", "PE": "es"
}
...
async def generate_digital_fans(count: int = 100) -> List[DigitalFan]:
    ...
    for i in range(count):
        ...
        country_iso = {
            "Argentina": "AR", "Brazil": "BR", "France": "FR", "England": "GB",
            "Spain": "ES", "Germany": "DE", "Netherlands": "NL", "Portugal": "PT",
            "Belgium": "BE", "Croatia": "HR", "Italy": "IT", "Morocco": "MA",
            "Mexico": "MX", "USA": "US", "Canada": "CA", "Japan": "JP",
            "South Korea": "KR", "Australia": "AU", "Senegal": "SN", "Ghana": "GH",
            "Nigeria": "NG", "Egypt": "EG", "Saudi Arabia": "SA", "Iran": "IR",
            "Qatar": "QA", "Ecuador": "EC", "Uruguay": "UY", "Chile": "CL",
            "Colombia": "CO", "Peru": "PE"
        }.get(country_code, "US")
        ...
        age = random.choices(
            ...
            weights=[1 if a < 25 else 3 if a < 40 else 2 if a < 60 else 1 for a in range(16, 80)],
            k=1
        )[0]
        ...
        emotion_weights = [15, 20, 5, 10, 5, 10, 5, 30]  # excited, joyful, angry, stressed, confused, tired, fearful, neutral
        current_emotion = random.choices(
            population=list(FanEmotion),
        ...
        base_excitement = random.randint(30, 90) if current_emotion in [FanEmotion.EXCITED, FanEmotion.JOYFUL] else random.randint(20, 60)
        ...
        fan = DigitalFan(
            ...
            medical_risk_score=random.randint(5, 30) + (age - 40) if age > 40 else random.randint(5, 20),
            ...
            predicted_next_action=random.choice([
                "Moving to food court", "Heading to restroom", "Finding seat", 
                "Exploring stadium", "Meeting friends", "Taking photos"
            ]),
...
async def generate_volunteers(count: int = 20) -> List[Volunteer]:
    ...
    volunteer_names = [
        "Alex Johnson", "Maria Rodriguez", "David Smith", "Sarah Kim", "Carlos Mendez",
        "Jennifer Liu", "Michael Brown", "Ana Santos", "James Wilson", "Lisa Chen",
        "Roberto Garcia", "Emma Davis", "Ahmed Hassan", "Sophie Martin", "Juan Lopez",
        "Rachel Green", "Pierre Dubois", "Yuki Tanaka", "Marco Rossi", "Elena Petrov"
    ]
    
    # Volunteer positions around the stadium
    volunteer_positions = [
        (40.8140, -74.0750), (40.8135, -74.0740), (40.8130, -74.0745),
        (40.8125, -74.0755), (40.8145, -74.0745), (40.8125, -74.0745),
        (40.8135, -74.0735), (40.8135, -74.0755), (40.8142, -74.0752),
        (40.8142, -74.0738), (40.8128, -74.0752), (40.8128, -74.0738),
        (40.8135, -74.0745), (40.8145, -74.0745), (40.8125, -74.0745),
        (40.8140, -74.0760), (40.8130, -74.0730), (40.8138, -74.0748),
        (40.8132, -74.0742), (40.8141, -74.0747)
    ]
    ...
    for zone_type, zone_data in STADIUM_ZONES.items():
        for zone_name, zone_info in zone_data.items():
            ...
            zone = StadiumZone(
                ...
                level=1,
                accessibility_features=["wheelchair_accessible", "elevator"] if random.random() > 0.5 else []
            )
            zones.append(zone)
            ...
            facility = StadiumFacility(
                ...
                accessibility_features=["wheelchair_accessible"] if random.random() > 0.3 else []
            )
...
async def main():
    ...
    try:
        ...
        async with AsyncSessionLocal() as session:
            ...
            print(f"👥 Generating 100 digital fans...")
            fans = await generate_digital_fans(100)
            for fan in fans:
                session.add(fan)
            
            # Generate volunteers
            print(f"🙋 Generating 20 volunteers...")
            volunteers = await generate_volunteers(20)
            for volunteer in volunteers:
                session.add(volunteer)
            
            # Generate stadium zones and facilities
            print(f"🏗️  Generating stadium zones and facilities...")
            ...
            print(f"🌤️  Generating weather data...")
        ...
        print("\nGenerated:")
        print(f"  • 100 Digital Fans with realistic behaviors")
        print(f"  • 20 Volunteers with various skills")

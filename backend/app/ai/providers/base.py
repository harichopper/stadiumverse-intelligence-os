...
class AIProvider(ABC):
    ...
    def update_performance_metrics(
        self, latency_ms: float, token_count: int, success: bool
    ):
    ...
    async def generate_agent_response(
        ...
        **kwargs,
        ...
        if context:
            ...
            messages.insert(
                -1, AIMessage(role=MessageRole.USER, content=context_message)
            )
        ...
        try:
            ...
            self.update_performance_metrics(
                response.latency_ms, response.token_count, True
            )
    ...
    async def generate_storyteller_response(
        self, scenario: Dict[str, Any], style: str = "narrative", **kwargs
    ) -> AIResponse:
        """

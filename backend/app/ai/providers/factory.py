...
async def validate_ai_provider(provider: AIProvider) -> Dict[str, Any]:
    ...
    try:
        ...
        test_messages = [
            ...
            AIMessage(role=MessageRole.USER, content="Say 'Hello from StadiumVerse AI' and nothing else.")
        ]
...
async def initialize_global_provider(provider_config: Dict[str, Any] = None) -> AIProvider:
    """
    ...
    if _global_provider is None:
        ...
        if not validation["healthy"]:
            ...
            raise ProviderConfigurationError(f"Global AI provider is unhealthy: {validation['error']}")
